...
class NewParser
{
    ...
    private static function sortTokens($input)
    {
        ...
        foreach ($input as $token) {
            ...
            if ($type === NewLexer::TYPE_OPERATOR) {
